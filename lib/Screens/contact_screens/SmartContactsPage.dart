                ...
                return Scaffold(
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) {
                              return new AddunsavedNumber(prefs: widget.prefs, model: widget.model, currentUserNo: widget.currentUserNo);
                            }));
                          },
                        ),
                        IconButton(
                    ...
                    body:
                        ...
                        availableContacts.searchingcontactsindatabase == true
                            ...
                            : RefreshIndicator(
                                onRefresh: () {
                                  return availableContacts.fetchContacts(context, model, widget.currentUserNo, widget.prefs);
                                },
                                    ...
                                    : ListView(
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            title: Text(
                                              getTranslated(context, 'creategroup'),
                                            ),
                                            contentPadding: EdgeInsets.symmetric(horizontal: 22.0, vertical: 11.0),
                                            onTap: () {
                                          ...
                                          availableContacts.joinedUserPhoneStringAsInServer.length == 0
                                              ? SizedBox(
                                                  height: 0,
                                                )
                                              : ListView.builder(
                                                  ...
                                                  itemCount: availableContacts.joinedUserPhoneStringAsInServer.length,
                                                  itemBuilder: (context, idx) {
                                                    JoinedUserModel user = availableContacts.joinedUserPhoneStringAsInServer.elementAt(idx);
                                                    ...
                                                    return ListTile(
                                                      ...
                                                      leading: FutureBuilder(
                                                        ...
                                                        builder: (BuildContext context, AsyncSnapshot snapshot) {
                                                          if (snapshot.hasData && snapshot.data.exists) {
                                                            return customCircleAvatar(url: snapshot.data[Dbkeys.photoUrl], radius: 22);
                                                          }
                                                          return CircleAvatar(
                                                      ...
                                                      title: Text(name, style: TextStyle(color: fiberchatBlack)),
                                                      ...
                                                      onTap: () {
                                                        ...
                                                        if (wUser != null && wUser[Dbkeys.chatStatus] != null) {
                                                          if (model.currentUser![Dbkeys.locked] != null && model.currentUser![Dbkeys.locked].contains(phone)) {
                                                            ChatController.authenticate(model, getTranslated(context, 'auth_neededchat'),
                                                                prefs: widget.prefs,
                                                                shouldPop: false,
                                                              ...
                                                              Navigator.pushAndRemoveUntil(
                                                                  ...
                                                                  new MaterialPageRoute(
                                                                      builder: (context) =>
                                                                          new ChatScreen(prefs: widget.prefs, model: model, currentUserNo: widget.currentUserNo, peerNo: phone, unread: 0)),
                                                                  (Route r) => r.isFirst);
                                                            });
                                                          } else {
                                          ...
                                          ListView.builder(
                                            ...
                                            itemBuilder: (context, idx) {
                                              ...
                                              return availableContacts.joinedcontactsInSharePref.indexWhere((element) => element.phone == phone) >= 0
                                                  ? Container(
                                                      width: 0,
                                                    )
                                                  : Stack(
                                                      children: [
                                                        ListTile(
                                                          ...
                                                          leading: CircleAvatar(
                                                              backgroundColor: fiberchatgreen,
                                                              radius: 22.5,
                                                              child: Text(Fiberchat.getInitials(user.value),
                                                                style: TextStyle(color: fiberchatWhite),
                                                              )),
                                                          title: Text(user.value, style: TextStyle(color: fiberchatBlack)),
                                                          subtitle: Text(phone, style: TextStyle(color: fiberchatGrey)),
                                                          contentPadding: EdgeInsets.symmetric(horizontal: 22.0, vertical: 0.0),
                                                          onTap: () {
                                                            hidekeyboard(context);
