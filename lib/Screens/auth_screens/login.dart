...
import 'package:fiberchat/Screens/homepage/introScreen.dart';
...
import 'package:fiberchat/widgets/PinEntryTextField/PinEntryTextField.dart';
...
class LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return (_loading)
        ...
        : Fiberchat.getNTPWrappedWidget(Scaffold(
              ...
              children: <Widget>[
                _currentStep == 0
                    ? Column(
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(15, MediaQuery.of(context).size.height / 3.50, 16, 0),
                            child: Column(
                              children: <Widget>[
                                SizedBox(
                                  height: 13,
                                ...
                                Text('Please Log In To Continue' , style: TextStyle(fontStyle: FontStyle.italic , fontSize: 20 , color: Color(0xFF6C6C6C)),),
                                        ...
                                        children: <TextSpan>[
                                          TextSpan(
                                              ...
                                              style: TextStyle(
                                                  ...
                                                  height: 1.7)),
                                          TextSpan(
                                            text: getTranslated(context, 'tnc'),
                    ...
                    : Container(
                        ...
                        margin: EdgeInsets.fromLTRB(15, MediaQuery.of(context).size.height / 2.50, 16, 0),
                        child: Column(
                          children: <Widget>[
                            SizedBox(
                              height: 13,
...
class _MobileInputWithOutlineState extends State<MobileInputWithOutline> {
  BoxDecoration boxDecoration({double radius = 5, Color bgColor = Colors.white, var showShadow = false}) {
    return BoxDecoration(
        color: bgColor,
        boxShadow: showShadow ? [BoxShadow(color: fiberchatgreen, blurRadius: 10, spreadRadius: 2)] : [BoxShadow(color: Colors.transparent)],
      ...
      children: [
        Container(
          ...
          child: IntlPhoneField(
              ...
              style: TextStyle(height: 1.5, letterSpacing: 1, fontSize: 16.0, color: widget.buttonTextColor ?? Colors.black87, fontWeight: FontWeight.bold),
              inputFormatters: [
...
class _InpuTextBoxState extends State<InpuTextBox> {
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      child: Container(
        margin: EdgeInsets.fromLTRB(widget.leftrightmargin ?? 8, 5, widget.leftrightmargin ?? 8, 5),
                    ...
                    prefixIcon: widget.prefixIconbutton != null
                        ? Container(
                            decoration: BoxDecoration(
                              border: Border(
                                right: BorderSide(
                                    width: widget.boxborderwidth ?? 1.5, color: widget.showIconboundary == true || widget.showIconboundary == null ? Colors.grey.withOpacity(0.3) : Colors.transparent),
                              ),
                              // color: Colors.white,
                            ),
