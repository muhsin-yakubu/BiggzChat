                                ...
                                children: <Widget>[
                                  StreamBuilder(
                                      ...
                                      builder: (context, AsyncSnapshot snapshot) {
                                        ...
                                        //     int seen = !snapshot.data.data().containsKey(widget.currentUserNo) ? 0 : 0;
                                        //   if (snapshot.data.data().containsKey(widget.currentUserNo)) {
                                        //     snapshot.data[Dbkeys.statusITEMSLIST].forEach((status) {
                                        //       if (snapshot.data[widget.currentUserNo].contains(status[Dbkeys.statusItemID])) {seen = seen + 1;}
                                        //     });
                                        //   }
                                        //
                                        //   return ;
                                  ...
                                  //     children: [
                                  //       Text(getTranslated(context, 'rcntupdates'), style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold),),
                                  //       SizedBox(
                                  //         width: 13,
                                  //       ),
                                  //       statusProvider.searchingcontactsstatus == true
                                  ...
                                  //                 child: CircularProgressIndicator(
                                  //                     strokeWidth: 1.5, valueColor: AlwaysStoppedAnimation<Color>(
                                  //                             fiberchatBlue)),
                                  //               ),
                                  //             ),
                                  //             color: Colors.transparent)
