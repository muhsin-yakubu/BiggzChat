...
void main() async {
  ...
  if (IsBannerAdShow == true || IsInterstitialAdShow == true || IsVideoAdShow == true) Admob.initialize();
  if (Platform.isIOS == true && (IsBannerAdShow == true || IsInterstitialAdShow == true || IsVideoAdShow == true)) await Admob.requestTrackingAuthorization();
                    ...
                    if (snapshot.hasData) {
                      return MultiProvider(
                        providers: [
                          ...
                          ChangeNotifierProvider(create: (_) => StatusViewProvider()),
                        ],
                        child: StreamProvider<List<BroadcastModel>>(
                          ...
                          child: StreamProvider<List<GroupModel>>(
                            ...
                            child: MaterialApp(
                              ...
                              theme: ThemeData(fontFamily: FONTFAMILY_NAME, primaryColor: fiberchatgreen, primaryColorLight: fiberchatgreen, indicatorColor: fiberchatLightGreen),
                              title: Appname,
                              ...
                              home: Homepage(
                                ...
                                isSecuritySetupDone: snapshot.data!.getString(Dbkeys.isSecuritySetupDone) == null
                                    ? false
                                    : ((snapshot.data!.getString(Dbkeys.phone) == null)
                                        ? false
                                        : (snapshot.data!.getString(Dbkeys.isSecuritySetupDone) == snapshot.data!.getString(Dbkeys.phone))
                                            ? true
                                            : false),
                              ),
